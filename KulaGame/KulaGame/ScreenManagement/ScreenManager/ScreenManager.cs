...
namespace KulaGame.ScreenManagement.ScreenManager
{
    /// <summary>
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        SpriteFont font;
        private SpriteFont andyFont;
        private SpriteFont jingFont;
        ...
        public SpriteFont AndyFont
        {
            get { return andyFont; }
        }

        public SpriteFont JingFont
        {
            get { return jingFont; }
        }
        /// <summary>
        ...
        protected override void LoadContent()
        {
            ...
            font = content.Load<SpriteFont>("Content/ScreenManager/Font/MenuTitle");
            andyFont = content.Load<SpriteFont>(@"Content/ScreenManager/Font/Andy");
            jingFont = content.Load<SpriteFont>(@"Content/ScreenManager/Font/jing");
