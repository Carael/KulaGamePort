...
namespace KulaGame.ScreenManagement.Controls
{
    ...
    class PageFlipControl : PanelControl
    {
        ...
        public bool HighscoresWasTapped { get; private set; }
        ...
        public override void Update(GameTime gametime)
        {
            ...
            if (tracker.WasTapped == true)
            {
                ObjectId = tracker.CurrentPage + 1;
                WasTapped = true;
            }
            if (tracker.HighscoresWasTapped == true)
            {
                ObjectId = tracker.CurrentPage + 1;
        ...
        public void SetTrackerPage(int pageNr)
        {
            tracker.SetPage(pageNr);
        }
